...
import { LOAD_TYPE_LABELS, LOAD_TYPES } from "@/app/utils/loadTypes";
...
export default function InputSpan({ span, index, onChange }: SpanInputProps) {
  const spanLabel =
  ...
  return (
    <div className="p-6 border-teal-900 shadow-xl hover:shadow-2xl duration-500 rounded-lg space-y-4">
      <h3 className="text-lg text-center uppercase font-semibold mb-4">
        SPAN {spanLabel}
      </h3>
